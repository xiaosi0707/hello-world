...
$('#js-sports').click(function() {
	openMask();
	$('.m-check li').click(function() {
		choiceCheck(this);
	})
})

$('.m-radio li').click(function() {
...
//多选
function choiceCheck(objThis) {
	if($(objThis).attr('flag') == 'false') {
		$(objThis).addClass('active').attr('flag', 'true');

	} else {
		$(objThis).removeClass('active').attr('flag', 'false');
	}
}
...
//删除提示
$('.m-userlist-re img').click(function() {
